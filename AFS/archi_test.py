...
class AFSArchitectureSearch:
    ...
    def get_architecture_configs(self):
        ...
        return {
            ...
            'e_node': [16, 32, 64, 128, 256, 512],  # Extraction network size
            'a_node': [2, 4, 6, 8, 16],  # Attention network output size
    ...
    def search(self):
        ...
        for v in product(*values):
            ...
            'per_class_metrics': {
                'precision': test_metrics['per_class_precision'].tolist(),
                'recall': test_metrics['per_class_recall'].tolist(),
                'f1': test_metrics['per_class_f1'].tolist()
            },
